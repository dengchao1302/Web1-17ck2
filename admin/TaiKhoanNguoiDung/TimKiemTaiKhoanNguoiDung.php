    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        if(isset($_POST["btnSearch"]))
        {
          ...
          $sql = "select * from TaiKhoan left join LoaiTaiKhoan on TaiKhoan.MaLoaiTaiKhoan = LoaiTaiKhoan.MaLoaiTaiKhoan where MaTaiKhoan = '" . $maTaiKhoan . "' ";
        ...
        <div class="card mb-3">
          ...
          Tìm kiếm tài khoản</div>
          <div class="card-body">
            <div class="table-responsive">
              <form action="TimKiemTaiKhoanNguoiDung.php" method="POST" name="frmSearch" id="frmSearch">
                        ...
                        <table>
                          <thead>
                            ...
                            <tbody>
                              ...
                              ?>
                              <tr>
                                <td colspan="2">Không tìm thấy tài khoản thỏa yêu cầu</td>
                              </tr>
                              <?php
                            }
                            ?>
