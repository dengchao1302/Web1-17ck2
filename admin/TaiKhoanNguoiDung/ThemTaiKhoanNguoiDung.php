    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        if(isset($_POST["btnAdd"]))
        {
          ...
          $sql = "insert into TaiKhoan(TenDangNhap,MatKhau,TenHienThi,DiaChi,DienThoai,Email,MaLoaiTaiKhoan) values ('". $tenDangNhap ."', '" . $matKhau ."', '" . $tenHienThi ."', '" . $diaChi ."', '" . $dienThoai ."', '" . $email ."', '" . $maLoaiTaiKhoan ."')";
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <form action="ThemTaiKhoanNguoiDung.php" method="POST" name="frmThem" id="frmThem">
                    ...
                    <tr>
                      ...
                      <td>
                        <select name="MaLoaiTaiKhoan">
                          <?php
                          while ($row = mysqli_fetch_array($listLTK)) {
                            ?>
                            <option value="<?php echo $row["MaLoaiTaiKhoan"]; ?>">
