        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <form action="XoaTaiKhoanNguoiDung.php" method="POST" name="frmDelete" id="frmDelete">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <thead>
                    ...
                    if ($check == 1) {
                      ?>
                      <tr>
                        <td colspan="2" style="background-color: green"> Xóa thành công </td>
                      </tr>
                      <?php 
                    } else if ($check == 0) {
                      ?>
                      <tr>
                        <td colspan="2" style="background-color: red"> Xóa thất bại </td>
                      </tr>
                      <?php 
                    }
                    ?>
