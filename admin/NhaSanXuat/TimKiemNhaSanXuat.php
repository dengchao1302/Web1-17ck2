    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        if(isset($_POST["btnSearch"]))
        {
          ...
          $sql = "select * from HangSanXuat where MaHangSanXuat = '" . $maNhaSanXuat . "' ";
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <form action="TimKiemNhaSanXuat.php" method="POST" name="frmSearch" id="frmSearch">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                          ...
                          <thead>
                            ...
                            <tbody>
                              ...
                              while ($row = mysqli_fetch_array($list)) {
                                ?>
                                <tr>
                                  <td><a href="SuaNhaSanXuat.php?id=<?php echo $row["MaHangSanXuat"]; ?>"><?php echo $row["MaHangSanXuat"]; ?></td>
                              ...
                              ?>
                              <tr>
                                <td colspan="2">Không tìm thấy nhà sản xuất thỏa yêu cầu</td>
                              </tr>
                              <?php
                            }
                            ?>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><input type="text" name="MaNhaSanXuat"></td>
                    </tr>
                  </tbody>
                </table>
              </form>
