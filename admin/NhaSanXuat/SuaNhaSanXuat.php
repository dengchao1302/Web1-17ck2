    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        if(isset($_POST["btnUpdate"]))
        {
          ...
          $sql = "update HangSanXuat set TenHangSanXuat='" . $tenNhaSanXuat . "' where MaHangSanXuat= '" . $maNhaSanXuat . "' ";
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <form action="SuaNhaSanXuat.php" method="POST" name="frmSua" id="frmSua">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tfoot>
                  ...
                  ?>
                  <tr>
                    <td colspan="2"> Thêm thành công </td>
                  </tr>
                  <?php 
                  } else if ($check == 0) {
                  ?>
                  <tr>
                    <td colspan="2"> Thêm thất bại </td>
                  </tr>
                  <?php 
                  }
                  ?>
