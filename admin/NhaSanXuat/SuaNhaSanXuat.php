...
if (!isset($_GET["id"]) || $_GET["id"] == "") {
  header('Location: LietKeNhaSanXuat.php');
}
...
if(isset($_POST["btnUpdate"]))
{
  ...
  $sql = "update HangSanXuat set TenHangSanXuat='" . $tenHangSanXuat . "' where MaHangSanXuat = '" . $_GET["id"] . "' ";
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          Sửa nhà sản xuất</div>
          <div class="card-body">
            <div class="table-responsive">
              <form action="SuaNhaSanXuat.php?id=<?php echo $_GET["id"] ?>" method="POST" name="frmSua" id="frmSua">
                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_array($list)) {
                      ...
                      <tr>
                        ...
                        <td><input type="text" name="MaHangSanXuat" value="<?php echo $row["MaHangSanXuat"]; ?>" disabled></td>
                      </tr>
                      <tr>
