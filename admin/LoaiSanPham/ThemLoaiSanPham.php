        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <form action="ThemLoaiSanPham.php" method="POST" name="frmThem" id="frmThem">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <thead>
                    ...
                    if ($check == 1) {
                      ?>
                      <tr>
                        <td colspan="2" style="background-color: green"> Thêm loại sản phẩm thành công </td>
                      </tr>
                      <?php 
                    } else if ($check == 0) {
                      ?>
                      <tr>
                        <td colspan="2" style="background-color: red"> Thêm loại sản phẩm thất bại </td>
                      </tr>
                      <?php 
                    }
                    ?>
