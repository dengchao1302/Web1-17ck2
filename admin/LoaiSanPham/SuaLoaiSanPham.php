...
if (!isset($_GET["id"]) || $_GET["id"] == "") {
  header('Location: LietKeLoaiSanPham.php');
}
...
if(isset($_POST["btnUpdate"]))
{
  ...
  $sql = "update LoaiSanPham set TenLoaiSanPham='" . $tenLoaiSanPham . "' where MaLoaiSanPham = '" . $_GET["id"] . "' ";
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          Sửa loại sản phẩm</div>
          <div class="card-body">
            <div class="table-responsive">
              <form action="SuaLoaiSanPham.php?id=<?php echo $_GET["id"] ?>" method="POST" name="frmSua" id="frmSua">
                  ...
                  <tbody>
                   ...
                   while ($row = mysqli_fetch_array($list)) {
                    ...
                    <tr>
                      ...
                      <td><input type="text" name="MaLoaiSanPham" value="<?php echo $row["MaLoaiSanPham"]; ?>" disabled></td>
                    </tr>
                    <tr>
