    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          Tìm kiếm loại sản phẩm</div>
          <div class="card-body">
            <div class="table-responsive">
              <form action="TimKiemLoaiSanPham.php" method="POST" name="frmSearch" id="frmSearch">
                          ...
                          <thead>
                            ...
                            <tbody>
                              ...
                              while ($row = mysqli_fetch_array($list)) {
                                ...
                                <tr>
                                  <tr>
                                    <td><a href="SuaLoaiSanPham.php?id=<?php echo $row["MaLoaiSanPham"]; ?>"><?php echo $row["MaLoaiSanPham"]; ?></td>
                              ...
                              ?>
                              <tr>
                                <td colspan="2">Không tìm thấy loại sản phẩm thỏa yêu cầu</td>
                              </tr>
                              <?php
                            }
                            ?>
